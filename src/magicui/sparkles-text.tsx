...
const SparklesText: React.FC<SparklesTextProps> = ({
  text,
  as: Component = "div",
  colors = { first: "#A07CF7", second: "#FE8FB5" },
  className,
  sparklesCount = 10,
  ...props
}) => {
  ...
  return (
    ...
    >
      ...
      <strong className="relative bg-gradient-to-r from-[var(--sparkles-first-color)] to-[var(--sparkles-second-color)] bg-clip-text text-transparent w-5">
        {text}
      </strong>
    </Component>
  );
