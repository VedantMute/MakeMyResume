...
export default function List() {
  const defaultCertification = { name: "New Training", date: "January 2025" };
  const [certifications, setCertifications] = useState([
    { name: "Edunet Technical skills", date: "February 2024" },
    { name: "Google Clous study jams", date: "October 2023" }
